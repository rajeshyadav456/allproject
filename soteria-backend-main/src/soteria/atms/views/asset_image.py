...
from soteria.atms.services.asset_image import upload_asset_image


class AssetImageUploadAPI(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        url = upload_asset_image(serializer.validated_data["file"])
