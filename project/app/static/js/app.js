               ...
               var chart = new ApexCharts(
                ...
                if (apexdemo7.length > 0) {
                  var optionDonut = {
                    ...
                    colors: ['#8E54E9','#2129B0','#c4c4c4','#45aaf2','#e3324c'],
                        ...
                        fill: {
                            type: 'gradient',
                                gradient: {
                                  ...
                                  opacityFrom: 1,
                                  opacityTo:1,
                                  gradientToColors: ['#8E54E9', '#45aaf2' , '#2129B0'],
                                  stops: [0, 90, 100]
                                }
                          },
                        colors:['#8E54E9','#45aaf2', '#2129B0'],
                        series: [45, 55, 80],
                        ...
                        function plotAccordingToChoices() {
                            ...
                            if (data.length > 0) {
                                $.plot("#flot-series-toggle", data, {
                                    ...
                                    colors: ["#c4c4c4", "#fd9644", "#32b432", "#8E54E9", "#4776E6", "#e3324c", "#fb0792"],
                                    yaxis: {
                                        min: 0
                                    },
                                    xaxis: {
        ...
        if (morrisJS.length > 0) {
                    ...
                    if (cardealer1.length > 0) {
                        Morris.Donut({
                            element: cardealer1,
                            data: [
                                { label: "Registrants", value: 1500 },
                                { label: "Subscribers", value:400 }
                            ],
                            colors: ['#c4c4c4', '#2129B0']
                        });
                    }
